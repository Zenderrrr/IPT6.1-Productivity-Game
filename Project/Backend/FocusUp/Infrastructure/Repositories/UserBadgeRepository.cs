...
namespace FocusUp.Infrastructure.Repositories
{
    public class UserBadgeRepository : BaseRepository<UserBadge>
    {
        ...
        public List<UserBadge> GetByUserId(int userId, SqliteConnection connection, SqliteTransaction transaction)
        {
            using var cmd = connection.CreateCommand();
        ...
        public int Insert(UserBadge userBadge, SqliteConnection connection, SqliteTransaction transaction)
        {
            using var cmd = connection.CreateCommand();
            cmd.Transaction = transaction;
