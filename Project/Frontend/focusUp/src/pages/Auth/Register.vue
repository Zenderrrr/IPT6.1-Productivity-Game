        ...
        <div>
          ...
          <form @submit.prevent @submit="register">
            <div class="flex flex-col items-start justify-center mt-5 gap-1">
              ...
              >
                ...
                <label class="font-semibold" for="username">Benutzername</label>
              </div>
              <input
            ...
            <div class="relative flex flex-col items-start justify-center mt-5 gap-1">
              ...
              >
                ...
                <label class="font-semibold" for="passwordConfirm">Passwort bestätigen</label>
              </div>
              <input
                class="input-hover-default bg-[var(--background-color)] w-full rounded-lg px-4 py-2 border border-gray-200 outline-[var(--primary-color)]"
                id="passwordConfirm"
              ...
              <button
                @click="isPasswordVisibleConfirm = true"
              ...
              <button
                @click="isPasswordVisibleConfirm = false"
                v-if="showPasswordConfirm()"
                class="hover:text-[var(--primary-color)] transition duration-200 absolute right-0 top-4.5 px-3 py-3 text-[var(--text-color-light)] cursor-pointer"
              >
                <i class="fa-solid fa-xmark"></i>
          ...
          <div class="flex justify-center items-center gap-1 mb-4 mt-5">
            ...
            <div class="text-[var(--text-color-light)] text-xs text-nowrap flex gap-1">
              ...
              <RouterLink
                to="/login"
                class="color-change-secondary-animation text-[var(--primary-color)] font-semibold"
                >Anmelden</RouterLink
              >
            </div>
            <div class="h-0.5 w-[100%] bg-gray-200 rounded-2xl"></div>
