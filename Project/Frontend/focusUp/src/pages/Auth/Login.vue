      ...
      <div class="bg-[var(--surface-color)] base-element sm:w-[400px] w-full">
        ...
        <div class="my-6 visual relative" aria-hidden="true">
          <svg viewBox="0 0 360 110" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            >
              ...
              <animate
                attributeName="d"
                values="M72 64 Q74 59 72 54;M72 64 Q70 59 72 54;M72 64 Q74 59 72 54"
                dur="2s"
                repeatCount="indefinite"
              />
            </path>
            <path
              d="M78 62 Q80 57 78 52"
              stroke="#14B8A6"
              stroke-width="1.5"
              stroke-linecap="round"
              opacity=".4"
          ...
          <!-- Xp Visual-->
          <div
            class="levitation-animation absolute top-[10px] left-[30px] text-xs flex items-center justify-center gap-2 border border-[var(--primary-color)] bg-[var(--primary-color-light)] rounded-lg px-2 py-1 text-[var(--primary-color)]"
          >
            <span>+50 XP</span>
          </div>
          ...
          <!-- Streak Visual-->
          <div
            class="levitation-animation absolute top-[10px] right-[30px] text-xs flex items-center justify-center gap-1 border border-red-400 bg-red-100 rounded-lg px-2 py-1 text-red-400"
          >
            <span class="">12</span>
        ...
        <div>
          ...
          <h1 class="font-bold text-2xl">
            Willkommen <em class="text-[var(--primary-color)]">zurück</em>
          </h1>
          <p class="text-sm text-[var(--text-color-light)]">
            Melde dich an, um weiter Fortschritte zu machen
          </p>
          ...
          <form @submit.prevent @submit="submit">
            <div class="flex flex-col items-start justify-center mt-5 gap-1">
              <div
                class="flex items-center justify-start gap-1 text-[var(--text-color-light)] text-xs uppercase"
              >
                <i class="fa-regular fa-envelope"></i>
                <label class="font-semibold" for="email">E-Mail / Benutzername</label>
              </div>
              <input
            ...
            <div class="relative flex flex-col items-start justify-center mt-5 gap-1">
              ...
              >
                ...
                <label class="font-semibold" for="password">Passwort</label>
              </div>
              <input
                class="input-hover-default bg-[var(--background-color)] w-full rounded-lg px-4 py-2 border border-gray-200 outline-[var(--primary-color)]"
                id="password"
              ...
              <button
                ...
                v-if="!showPassword()"
                class="hover:text-[var(--primary-color)] transition duration-200 absolute right-0 top-4.5 px-3 py-3 text-[var(--text-color-light)] cursor-pointer"
              >
              ...
              <button
                ...
                v-if="showPassword()"
                class="hover:text-[var(--primary-color)] absolute right-0 top-4.5 px-3 py-3 text-[var(--text-color-light)] cursor-pointer"
              >
          ...
          <div class="flex justify-center items-center gap-1 my-4">
            ...
            <span class="text-[var(--text-color-light)] text-xs">oder</span>
            <div class="h-0.5 w-[100%] bg-gray-200 rounded-2xl"></div>
          </div>
