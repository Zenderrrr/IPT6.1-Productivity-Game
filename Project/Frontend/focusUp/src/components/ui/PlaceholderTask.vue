...
<template>
  <div
    class="unchecked shrink-0 overflow-hidden relative border-1 border-transparent cursor-pointer base-element w-full flex items-center justify-start gap-4"
  >
